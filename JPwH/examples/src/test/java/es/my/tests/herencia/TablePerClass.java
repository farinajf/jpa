...
import es.my.model.entities.herencia.tableperclass.CuentaBancaria;
import es.my.model.entities.herencia.tableperclass.TarjetaCredito;
 ...
 * @author fran
 */
public class TablePerClass extends HerenciaBaseCRUD {
    ...
    /**************************************************************************/
    @Override
    public void configurePU() throws Exception {super.configurePU("myTablePerClassPUnit");}
