...
import es.my.model.entities.herencia.joined.CuentaBancaria;
import es.my.model.entities.herencia.joined.TarjetaCredito;
 ...
 * @author fran
 */
public class Joined extends HerenciaBaseCRUD {
    ...
    /**************************************************************************/
    @Override
    public void configurePU() throws Exception {super.configurePU("myJoinedPUnit");}
