...
import es.my.model.entities.colecciones.setofembeddablesorderby.Imagen;
import es.my.model.entities.colecciones.setofembeddablesorderby.Item;
...
public class SetOfEmbeddablesOrderBy extends JPATest {
    ...
    /**************************************************************************/
    @Override
    public void configurePU() throws Exception {super.configurePU("mySetOfEmbeddablesOrderByPUnit");}
