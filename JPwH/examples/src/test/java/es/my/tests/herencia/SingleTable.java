...
import es.my.model.entities.herencia.singletable.CuentaBancaria;
import es.my.model.entities.herencia.singletable.TarjetaCredito;
 ...
 * @author fran
 */
public class SingleTable extends HerenciaBaseCRUD {
    ...
    /**************************************************************************/
    @Override
    public void configurePU() throws Exception {super.configurePU("mySingleTablePUnit");}
