...
public class NPlusOneSelects extends JPATest {
    ...
    public void fetchUsers() throws Exception {
        ...
        try
        {
            ...
            Constants.print("Item.count:    " + _loadEventListener.getLoadCount(Item.class));
            Constants.print("Usuario.count: " + _loadEventListener.getLoadCount(Usuario.class));

            //SELECT * FROM USUARIOS WHERE ID = ?
            for (Item i : items) Constants.print("Vendedor: " + i.getVendedor().getNombre());
    ...
    public void fetchBids() throws Exception {
        ...
        try
        {
            ...
            Constants.print("Item.count: " + _loadEventListener.getLoadCount(Item.class));
            Constants.print("Bid.count:  " + _loadEventListener.getLoadCount(Bid.class));
