...
import es.my.model.entities.colecciones.bagofstringsorderby.Item;
...
public class BagOfStringsOrderBy extends JPATest {
    ...
    /**************************************************************************/
    @Override
    public void configurePU() throws Exception {super.configurePU("myBagOfStringsOrderByPUnit");}
    ...
    public void test() throws Exception {
        ...
        try
        {
            ...
            }
            {
                ...
                System.out.println("----------------------------------------------------------------");
                Constants.print(x);
                for (String i : x.getImagenes()) Constants.print(i);
