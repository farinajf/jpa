...
public enum DatabaseProduct {
    ...
    ORACLE (new DataSourceConfiguration() {
            ...
            public void configure(PoolingDataSource ds, String connectionURL) {
                ...
                //ds.getDriverProperties().put("URL", connectionURL != null ? connectionURL : "jdbc:oracle:thin:test/test@192.168.56.101:1521:xe");
                ds.getDriverProperties().put("URL", connectionURL != null ? connectionURL : "jdbc:oracle:thin:test/test@127.0.0.1:1521:xe");
    ...
    POSTGRESQL (new DataSourceConfiguration() {
            ...
            public void configure(PoolingDataSource ds, String connectionURL) {
                ...
                if (connectionURL != null) throw new IllegalArgumentException("PostgreSQL XADataSource doesn't support connection URLs");
    ...
    MYSQL(new DataSourceConfiguration() {
            ...
            public void configure(PoolingDataSource ds, String connectionURL) {
                ...
                ds.getDriverProperties().put("url", connectionURL != null ? connectionURL : "jdbc:mysql://localhost/test?sessionVariables=sql_mode='PIPES_AS_CONCAT'");
